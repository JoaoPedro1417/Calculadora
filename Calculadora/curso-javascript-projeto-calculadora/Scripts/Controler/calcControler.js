...
class CalcControler {
    ...
    initKeyboard(){
        ...
        document.addEventListener("keyup", e=>{
            ...
            switch (e.key) {
                ...
                case "Backspace": this.clearEntry (); break; 
          
                case "+": case "-": case "*": case "/": case "%": this.addOp(e.key) ; break; 
               
                case "Enter": case "=": this.calc() ; break;
    
                case "ponto": case ",": this.addDot(".") ; break;
                ...
                case "8": 
                case "9":
                    this.addOp(parseInt(e.key)); break; 

                case "c": if(e.ctrlKey) this.copyToClipboard(); 
                break; 
    ...
    calc(){
            ...
            if (this._operation.length <3){
                ...
                this._operation = [firsItem, this._lastOp, this._lastNumber]; 
    ...
    addDot(){
        ...
        let lastOp = this.getLastOp(); 

        if(typeof lastOp === "string" && lastOp.split("").indexOf(".")> -1) return; 

        if (this.isOp(lastOp)  || !lastOp){

            this.pushOp("0."); 

        }else{

            this.setlastOp(lastOp.toString() + ".")
