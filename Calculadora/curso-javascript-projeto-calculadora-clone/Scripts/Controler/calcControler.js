...
class CalcControler {
    ...
    execBtn(value) {
        ...
        switch (value) {
            ...
            case "soma": this.soma(); break; 
            
            case "subtracao": this.subtracao(); break; 
                
            case "multiplicacao": this.multiplicacao(); break;

            case "divisao": this.divisao(); break; 
           
            case "porcento": this.porcento(); break; 
            
            case "igual": this.igual(); break;
